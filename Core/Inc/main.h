...
/* Private defines -----------------------------------------------------------*/
#define OUT_TEST_Pin GPIO_PIN_0
...
#define ADC_FLOW_Pin GPIO_PIN_4
#define ADC_FLOW_GPIO_Port GPIOA
#define ADC_TRIMPOT_Pin GPIO_PIN_5
#define ADC_TRIMPOT_GPIO_Port GPIOA
